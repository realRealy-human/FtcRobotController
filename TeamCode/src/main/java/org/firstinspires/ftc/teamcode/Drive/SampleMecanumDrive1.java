 ...
 */
@Config
public class SampleMecanumDrive1 extends MecanumDrive {
    ...
    public SampleMecanumDrive1(HardwareMap hardwareMap) {
        ...
        rightFront = hardwareMap.get(DcMotorEx.class, "rightMotor");
